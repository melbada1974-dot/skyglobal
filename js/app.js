...
// ═══════════════════════════════════════════════════════════════
// PARTNER MODAL — open/close + form submission + phone codes
// ═══════════════════════════════════════════════════════════════
(function() {
  // ── Phone country codes ──
  var countries = [
  ...
  var phoneSelect = document.getElementById('pm-phoneCountryCode');
  if (phoneSelect) {
  ...
  // Lenis가 window 캡처 단계에서 wheel 이벤트를 가로채므로,
  // 같은 캡처 단계에서 먼저 차단하여 모달 내 네이티브 스크롤 허용
...
// ── Global modal functions (called by onclick) ──
function openPartnerModal() {
  var modal = document.getElementById('partner-modal');
  modal.style.display = 'flex';
  document.documentElement.style.overflow = 'hidden';
  document.body.style.overflow = 'hidden';
  if (typeof lenisInst !== 'undefined' && lenisInst) lenisInst.stop();
}
function closePartnerModal() {
  document.getElementById('partner-modal').style.display = 'none';
  document.documentElement.style.overflow = '';
  document.body.style.overflow = '';
  if (typeof lenisInst !== 'undefined' && lenisInst) lenisInst.start();
}
function closeStModal() {
  document.getElementById('pm-success-modal').style.display = 'none';
  closePartnerModal();
}
